module.exports = {
	profileList : [
		...
		},
		{
			...
			replies: [
				{user: '유저1' , content: '방명록1'},
				{user: '유저2' , content: '방명록2'},
				{user: '유저3' , content: '방명록3'},
				{user: '유저4' , content: '방명록4'},
				{user: '유저5' , content: '방명록5'},
				{user: '유저6' , content: '방명록6'},
				{user: '유저7' , content: '방명록7'},
			],
			features: [
				{user: '유저1', feature: '특징1', up: 7, down: 3},
				{user: '유저2', feature: '특징2', up: 6, down: 3},
				{user: '유저3', feature: '특징3', up: 5, down: 3},
				{user: '유저4', feature: '특징4', up: 4, down: 3},
				{user: '유저5', feature: '특징5', up: 3, down: 3},
				{user: '유저6', feature: '특징6', up: 2, down: 3},
			]
		}
	],
